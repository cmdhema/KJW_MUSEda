...
public class PhotoCoverRemoveRequest extends PostNetworkRequest<UserData> {

	private UserData data;
	
	public PhotoCoverRemoveRequest(UserData list) {
		super(list);
		this.data = list;
	}
...
//		Log.i("PhotoCoverRemoveRequest", jsonBuf.toString());
		...
		try {
			...
			Log.e("PhotoCoverRemoveRequest", "JSON파싱중 에러 발생", je);
		}
