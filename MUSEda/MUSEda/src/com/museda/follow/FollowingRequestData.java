...
public class FollowingRequestData extends GetNetworkRequest<ArrayList<UserListData>> {

	private String serverURL;

	public FollowingRequestData(ArrayList<UserListData> data, UserListData requestData, String flag) {
		super(data);

		serverURL = NetworkConstant.SERVER_URL + flag + "?" + BuildQueryString.getFollowingListQueryString(requestData);

		Log.i("FollowingtRequest", serverURL);
	}
...
//		Log.i("FollowingtRequest", jsonBuf.toString());
