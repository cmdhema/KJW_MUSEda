...
public class SetFavoriteRequest extends PostNetworkRequest<HeartFavoriteData> {

	private String serverURL;
	private HeartFavoriteData requestData;
	
	public SetFavoriteRequest(HeartFavoriteData data, String flag) {
		super(data);
...
//		Log.i("SetHeartRequest", jsonBuf.toString());
		...
		try {
			...
			Log.e("SetFavoriteRequest", "JSON파싱중 에러 발생", je);
		}
