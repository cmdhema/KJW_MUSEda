d3 = function () {
    ...
    function gt(n, t, e, r) {
        ...
        var u = {}, a = va.dispatch("progress", "load", "error"),
    ...
    va.geom.hull = function (n) {
        ...
        function t(n) {
            ...
            if (c === Pe && l === Oe) t = n;
                ...
                for (t = new Array(f), a = 0; f > a; ++a) t[a] = [+c.call(this, u = n[a], a), +l.call(this, u, a)]; if (lr(t, function (n) {
                var t, e, r, i, u, a;
    ...
    var lc = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g;
    va.interpolate = wr, va.interpolators = [
        function (n, t) {
            var e = typeof t;
    ...
    va.ease = function (n) {
        ...
        var e, r, i, u, a, o = {}, c = va.dispatch("start", "tick", "end"),
            l = [1, 1],
            f = .9,
            s = gc,
            h = pc,
